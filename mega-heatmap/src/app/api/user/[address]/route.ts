...
export async function GET(
  ...
  try {
    ...
    const metrics = {
      ...
      activeGasEth: user.activeGasEth,
      gasMilestoneTier: user.gasMilestoneTier,
      usdmTransacted: user.usdmTransacted,
    ...
    const response = NextResponse.json({
      ...
      score_breakdown: {
        ...
        from_active_gas: breakdown.breakdown.fromActiveGas,
        from_gas_milestone: breakdown.breakdown.fromGasMilestone,
        from_usdm: breakdown.breakdown.fromUsdm,
